...
mod tests {
    ...
    fn test_convert_valid_lui_bits_into_instruction() {
        ...
        assert_eq!(instruction, Instruction::Lui { rd: Register::X25, imm: -858996736 });
    }
    ...
    fn test_convert_valid_auipc_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Auipc { rd: Register::X25, imm: -858996736 });
    }
    ...
    fn test_convert_valid_jal_bits_into_instruction() {
        let bits: Inst = 0b1100_1100_1100_1100_1100_1100_1110_1111 as u32;
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Jal { rd: Register::X25, imm: -212584 });
    }
    ...
    fn test_convert_valid_jalr_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Jalr { rd: Register::X11, rs1: Register::X21, imm: 3276 });
    }
    ...
    fn test_convert_valid_beq_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Beq { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, imm: -822, func3: 0 });
    }
    ...
    fn test_convert_valid_bne_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Bne { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, imm: -822, func3: 1 });
    }
    ...
    fn test_convert_valid_blt_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Blt { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, imm: -822, func3: 4 });
    }
    ...
    fn test_convert_valid_bge_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Bge { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, imm: -822, func3: 5 });
    }
    ...
    fn test_convert_valid_bltu_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Bltu { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, imm: -822, func3: 6 });
    }
    ...
    fn test_convert_valid_bgeu_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Bgeu { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, imm: -822, func3: 7 });
    }
    ...
    fn test_convert_valid_lb_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Lb { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 0 });
    }
    ...
    fn test_convert_valid_lh_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Lh { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 1 });
    }
    ...
    fn test_convert_valid_lw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Lw { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 2 });
    }
    ...
    fn test_convert_valid_lbu_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        // println!("{:?}", instruction);
        assert_eq!(instruction, Instruction::Lbu { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 4 });
    }
    ...
    fn test_convert_valid_lhu_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Lhu { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 5 })
    }
    ...
    fn test_convert_valid_sb_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        // println!("{:?}", instruction);
        assert_eq!(instruction, Instruction::Sb { rs1: Register::X21, rs2: Register::X12, imm: -821, func3: 0 });        
    }
    ...
    fn test_convert_valid_sh_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sh { rs1: Register::X21, rs2: Register::X12, imm: -821, func3: 1 });
    }
    ...
    fn test_convert_valid_sw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sw { rs1: Register::X21, rs2: Register::X12, imm: -821, func3: 2 });
    }
    ...
    fn test_convert_valid_addi_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Addi { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 0 });        
    }
    ...
    fn test_convert_valid_slti_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Slti { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 2 });        
    }
    ...
    fn test_convert_valid_sltiu_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sltiu { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 3 });        
    }
    ...
    fn test_convert_valid_xori_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Xori { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 4 });        
    }
    ...
    fn test_convert_valid_ori_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Ori { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 6 });        
    }
    ...
    fn test_convert_valid_andi_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Andi { rd: Register::X11, rs1: Register::X21, imm: 3276, func3: 7 });        
    }

    #[test]
    fn test_convert_valid_slli_bits_into_instruction() {
        let bits: Inst = 0b1100_1100_1100_1010_1001_0101_1001_0011 as u32;
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Slli { rd: Register::X11, rs1: Register::X21, shamt: 12, func3: 1, func7: 102 });
    }
    ...
    fn test_convert_valid_srli_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Srli { rd: Register::X11, rs1: Register::X21, shamt: 12, func3: 5, func7: 0 });
    }
    ...
    fn test_convert_valid_srai_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Srai { rd: Register::X11, rs1: Register::X21, shamt: 12, func3: 5, func7: 32 });
    ...
    fn test_convert_valid_add_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Add { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 0, func7: 0 });
    }
    ...
    fn test_convert_valid_sub_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sub { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 0, func7: 32 });
    }
    ...
    fn test_convert_valid_sll_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sll { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 1, func7: 0 });
    }
    ...
    fn test_convert_valid_slt_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Slt { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 2, func7: 0 });
    }
    ...
    fn test_convert_valid_sltu_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sltu { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 3, func7: 0 });
    }
    ...
    fn test_convert_valid_xor_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Xor { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 4, func7: 0 });
    }
    ...
    fn test_convert_valid_srl_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Srl { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 5, func7: 0 });
    }
    ...
    fn test_convert_valid_sra_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sra { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 5, func7: 32 });
    }
    ...
    fn test_convert_valid_or_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Or { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 6, func7: 0 });
    }
    ...
    fn test_convert_valid_and_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::And { rd: Register::X11, rs1: Register::X21, rs2: Register::X12, func3: 7, func7: 0 });
    }
    ...
    fn test_convert_valid_fence_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Fence { rd: Register::X11, rs1: Register::X21, fm: 0, pred: 0, succ: 0, func3: 0 });
    }
    ...
    fn test_convert_valid_lwu_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Lwu { rd: Register::X8, rs1: Register::X16, imm: 0, func3: 6 });        
    }
    ...
    fn test_convert_valid_ld_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Ld { rd: Register::X8, rs1: Register::X16, imm: 0, func3: 3 });        
    }
    ...
    fn test_convert_valid_sd_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sd { rs1: Register::X16, rs2: Register::X3, imm: 8, func3: 3 });        
    }
    ...
    fn test_convert_valid_addiw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Addiw { rd: Register::X8, rs1: Register::X16, imm: 3, func3: 0 });        
    }
    ...
    fn test_convert_valid_slliw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Slliw { rd: Register::X8, rs1: Register::X16, shamt: 3, func3: 1, func7: 0 });        
    }
    ...
    fn test_convert_valid_srliw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Srliw { rd: Register::X8, rs1: Register::X16, shamt: 3, func3: 5, func7: 0 });        
    }
    ...
    fn test_convert_valid_sraiw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sraiw { rd: Register::X8, rs1: Register::X16, shamt: 3, func3: 5, func7: 32 });        
    }
    ...
    fn test_convert_valid_addw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Addw { rd: Register::X8, rs1: Register::X16, rs2: Register::X3, func3: 0, func7: 0 });        
    }
    ...
    fn test_convert_valid_subw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Subw { rd: Register::X8, rs1: Register::X16, rs2: Register::X3, func3: 0, func7: 32 });        
    }
    ...
    fn test_convert_valid_sllw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sllw { rd: Register::X8, rs1: Register::X16, rs2: Register::X3, func3: 1, func7: 0 });        
    }
    ...
    fn test_convert_valid_srlw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Srlw { rd: Register::X8, rs1: Register::X16, rs2: Register::X3, func3: 5, func7: 0 });        
    }
    ...
    fn test_convert_valid_sraw_bits_into_instruction() {
        ...
        let instruction: Instruction = bits.into();
        assert_eq!(instruction, Instruction::Sraw { rd: Register::X8, rs1: Register::X16, rs2: Register::X3, func3: 5, func7: 32 });        
    }
}
